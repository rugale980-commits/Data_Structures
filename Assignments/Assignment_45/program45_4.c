...
//  Description   : Used to search check whether Number of X Count Greater
...
int main()
{
    ...
    iRet = CountGreater(First, 10);

    printf("Number of X Count greater is : %d\n", iRet);
...
//
//  output : Number of X Count greater is : 4
//
////////////////////////////////////////////////////////////////////////////////